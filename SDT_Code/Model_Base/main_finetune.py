...
def get_args_parser():
    ...
    parser.add_argument('--data_set', default='IMNET', type=str,
                    help='Dataset name (e.g., IMNET, CIFAR10, CIFAR100)')
    ...
    parser.add_argument('--surrogate_gradient_type', default='ori', type=str,
                        choices=['ori', 'atan', 'error_comp_atan', 'error_weighted_rect','trapezoid'],
                        help='Type of surrogate gradient to use for SNNs.')
    parser.add_argument('--sg_alpha', default=2.0, type=float,
                        help='Alpha parameter for surrogate gradients like ATan.')
    parser.add_argument('--sg_k', default=1.0, type=float,
                        help='Error compensation factor k for error-based gradients.')
...
def main(args):
    ...
    model_kwargs = {
        'num_classes': args.nb_classes, 
        'surrogate_gradient_type': args.surrogate_gradient_type,
        'alpha': args.sg_alpha,
        'k': args.sg_k
    }
